...
CC=gcc
APPN= ldshr
LFLAGS=-lm -pthread -lstdc++ -lcudart
...
$(APPN)_svc: $(APPN).h $(APPN)_shared.h $(APPN)_svc_proc.o $(APPN)_svc.o reduction.o \
$(APPN)_xdr.o
	$(CC) $(CFLAGS) -o $(APPN)_svc $(APPN)_svc_proc.o $(APPN)_svc.o reduction.o \
	$(APPN)_xdr.o $(LFLAGS) 
